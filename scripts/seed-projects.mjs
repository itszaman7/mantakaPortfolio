...
const projects = [
  {
    ...
    demo_link: "",
    story_challenge:
      "Farmers lacked direct access to market prices and weather data.",
    story_solution:
      "We built a centralized dashboard aggregation system using Node.js.",
  ...
  },
  {
    ...
    story_challenge:
      "Manual inventory tracking was causing stock discrepancies.",
    story_solution:
      "Implemented a real-time inventory sync using Firebase listeners.",
  ...
  },
  {
    ...
    description:
      "Event planning and management tool (Video Editing & Data Analysis).",
    ...
    story_solution:
      "Contributed to data analysis modules and produced promotional video content.",
  ...
  },
  {
    ...
    story_solution:
      "Gamified the recovery process with daily streaks and rewards.",
