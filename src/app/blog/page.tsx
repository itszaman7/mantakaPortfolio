...
// Ensure interface matches your database schema
interface Blog {
    id: string;
    title: string;
    slug: string;
...
export default function BlogIndexPage() {
    ...
    }, { dependencies: [blogs, loading], scope: containerRef });
        ...
        return (
            <div className="min-h-screen bg-white flex items-center justify-center -mt-20">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <span className="text-xs font-mono font-bold tracking-widest text-gray-400 uppercase">Loading Data...</span>
                </div>
            </div>
        );
    }
