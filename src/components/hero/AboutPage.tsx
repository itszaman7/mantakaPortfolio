        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-x-16 lg:gap-y-16 items-center">
          ...
          <div ref={textRef} className="lg:col-span-8 relative z-20 order-2 lg:order-1 min-w-0 pr-6 lg:pr-16">
            ...
            <div className="reveal-text">
               <a href="#" className="group inline-flex items-center gap-3 text-[10px] uppercase tracking-[0.25em] font-bold text-gray-900 transition-all duration-300 hover:text-[#FF2800] border-b-2 border-transparent hover:border-[#FF2800] pb-1 hover:tracking-[0.35em]">
                  Story 
...
src="/2D_Assets/me.jpg"
      ...
      <style dangerouslySetInnerHTML={{ __html: `.serif-font { font-family: 'Playfair Display', serif; }` }} />
    </div>
  );
};
